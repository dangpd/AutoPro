  ...
  <div class="select-box">
    <div class="select-box-select">
      ...
      <button @click="onShowHideData" @keydown="buttonOnKeyDown">
        <div class="select-box-icondown"></div>
      </button>
    </div>
    <div v-show="isShowData" class="selectbox__datadown" v-clickoutside="hideListData">
...
export default {
  ...
  watch: {
    ...
    modelValue(newVal) {
      ...
      let data = this.dataMain.find((item) => item.feildValue == newVal);
      if (data) {
