<template>
    <div>
        <div style="height: auto;width: 100%;">
            <div style="margin: 40px auto;padding-left:45%;font-size: 20px;font-weight: bold;">Kết quả giao dịch</div>
            <div style="margin: 40px auto;padding-left:40%;font-size: 16px;">Mã giao dịch : {{ queryPayment.vnp_BankTranNo
            }}
            </div>
            <div style="margin: 40px auto;padding-left:40%;font-size: 16px;">Mã đơn hàng : {{ queryPayment.vnp_OrderInfo }}
            </div>
            <div style="margin: 40px auto;padding-left:40%;font-size: 16px;">Ngày giao dịch : {{ queryPayment.vnp_PayDate }}
            </div>
            <div style="margin: 40px auto;padding-left:40%;font-size: 16px;">Ngân hàng giao dịch : {{
                queryPayment.vnp_BankCode }}</div>
            <div style="margin: 40px auto;padding-left:40%;font-size: 16px;">Loại giao dịch : {{ queryPayment.vnp_CardType
            }}
            </div>
