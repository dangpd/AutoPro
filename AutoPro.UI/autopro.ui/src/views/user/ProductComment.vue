        ...
        <div class="aform-account">
            ...
            <div class="form-input">
                ...
                <div class="login-password">
                    ...
                    <star-rating :show-rating="false" v-model:rating="rating" :animate="true"></star-rating>
                </div>
            </div>
...
export default {
    ...
    methods: {
        sendComment() {
            ...
            axios.post("https://localhost:7129/api/v1/ProductComment", comment)
                .then((res) => {
                    if (res.status == 201) {
    ...
    created() {
        if (this.idProduct) {
            ...
            axios.get(ApiUser.getUserById(idUser))
                .then((res) => {
                    if (res.status == 200) {
